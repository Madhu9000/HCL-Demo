...
<form name="form" method="post" action="AppServerReports">
<%
		...
		//	System.out.println("In Reports2 starting......");
			...
			String sql = "SELECT APPSERVER FROM CUSTOMER_METADATA ";
...
<center>
	<input type="submit" value="submit"/>
			<button><a href=helloWorld.jsp target=''> <font>
						Home</font></a> </button>
						<button><a href=AppServer.jsp target=''> <font>Back </font></a> </button>
